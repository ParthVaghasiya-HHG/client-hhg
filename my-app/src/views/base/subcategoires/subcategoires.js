...
const SubCategoires = () => {
  ...
  // function category() {
  //   axios.get('http://localhost:5000/vfinddata')
  //   .then(function (res){
  //     console.log(res.data.data);
  //     setcategry(res.data.data)
  //   })
  ...
  //   axios.get('http://localhost:5000/kfinonedata')
  //   .then(function (res){
  //     console.log(res.data.data);
  //     setList(res.data.data)
  //   })
    ...
    <>
      ...
      <CModal visible={visible} onClose={() => setVisible(false)}>
        ...
        <CModalFooter>
          ...
          <CButton className="btn1" onClick={submit} id="demo">
            Save
          </CButton>
        </CModalFooter>
      </CModal>
              ...
              .map((item, i) => {
                return (
                  <>
                    ...
                    >
                        ...
                        <div>
                          <figure>
                            <img
                              ...
                              key={i}
                              onClick={() =>
                                openImageViewer('http://localhost:5000/' + item.image_user)
                              }
                            />
                          </figure>
                          <span>Hover</span>
                      ...
                      <CCardBody>
                        ...
                        <CCardText style={{ color: 'white' }}>
                          <FaHandPointRight style={{ color: '#3A6073' }} /> {item.subcategorie}
                        </CCardText>
                        <CCardText className="font">
                          <FaHandPointRight style={{ color: '#3A6073' }} /> {item.description}
                        </CCardText>
                        <CButton
                          value="Update"
                          color="success"
                    ...
                    >
                      <CModalHeader>
                        <CModalTitle>Update Sub Category Form</CModalTitle>
                      </CModalHeader>
                      <CModalBody>
                        <CForm>
                          <div className="mb-3">
                        ...
                        <div>
                          <CRow>
                            ...
                            <CCol>
                              <img
                                style={{ height: '200px', width: '250px', borderRadius: '6px' }}
                                src={'http://localhost:5000/' + imageval}
                              ></img>
                            </CCol>
                          </CRow>
                        </div>
                    ...
                    return (
                      <>
                        <CTableRow
                          key={i}
                          style={{
                            backgroundImage: 'repeating-linear-gradient(to right,#16222A,#3A6073)',
                          }}
                        >
                          <CTableDataCell style={{ paddingTop: '30px', color: 'white' }}>
                            {i + 1}
                          </CTableDataCell>
                          <CTableHeaderCell style={{ paddingTop: '30px', color: 'white' }}>
                            {item.category}
                          </CTableHeaderCell>
                          <CTableDataCell style={{ paddingTop: '30px', color: 'white' }}>
                            {item.subcategorie}
                          ...
                          <CTableDataCell
                            className="font1"
                            style={{ paddingTop: '30px', width: '400px', color: 'white' }}
                          >
                            {item.description}
                          </CTableDataCell>
                          <CTableDataCell style={{ paddingTop: '30px', color: 'white' }}>
